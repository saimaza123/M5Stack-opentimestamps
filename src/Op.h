...
#define SHA256_DIGEST_LENGTH 30
...
public:
    ...
    mbedtls_sha1_update_ret(&sha1, msg, len);
...
public:
    ...
    mbedtls_sha256_context sha256;
		...
		mbedtls_sha256_update_ret(&sha256, msg, len);
...
// due to a shitty lib on arduino framework we use libwally
...
public:
    ...
    //mbedtls_ripemd160_init(&ripemd160);
		//RIPEMD160_Update(&ripemd160, msg, len);
		//mbedtls_ripemd160_update_ret(&ripemd160, msg, len);
		//RIPEMD160_Final(hash, &ripemd160);
		//mbedtls_ripemd160_finish_ret(&ripemd160, hash);
		wally_hash160(msg, len, hash, RIPEMD160_DIGEST_LENGTH);
		return RIPEMD160_DIGEST_LENGTH;
	}
};
